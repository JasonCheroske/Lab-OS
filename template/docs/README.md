...
- [../README.md](../README.md) — workspace entry (startup arc, validate / promote)
- [../AGENTS.md](../AGENTS.md) — guidance for AI assistants
- [project-structure.md](project-structure.md) — starter tree for this root
- `../lab.yaml` — lab metadata and stage

## Change history

| Date | Change summary | Editor |
| --- | --- | --- |
| 2026-03-27 | Link root README and AGENTS from mini-index. | Lab OS seed |
| 2026-03-27 | Initial template mini-index for init copy. | Lab OS seed |
